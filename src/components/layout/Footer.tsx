  ...
  <footer className="border-t border-border bg-card">
    <div className="container py-16">
      <div className="grid gap-12 md:grid-cols-4">
        <div className="md:col-span-1">
          <Link to="/" className="flex items-center gap-2 mb-4 group">
            ...
            <span className="text-xl font-heading tracking-widest uppercase">Somma</span>
          </Link>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Conectando você aos melhores profissionais do Brasil.
          </p>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2.5 text-sm text-muted-foreground">
            ...
            <Link to="/quiz" className="hover:text-primary transition-colors">Começar agora</Link>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2.5 text-sm text-muted-foreground">
            <span className="hover:text-primary transition-colors cursor-pointer">contato@somma.com.br</span>
      ...
      <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 text-xs text-muted-foreground md:flex-row">
        <span>© 2026 Somma. Todos os direitos reservados.</span>
